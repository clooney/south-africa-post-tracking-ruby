# South African Post Office Tracking API For Ruby
South African Post Office Tracking API and webhook make it easy to integrate South African Post Office Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a South African Post Office Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use South African Post Office Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [South African Post Office Tracking API](https://www.trackingmore.com/south-africa-post-tracking.html)  to:

   *   Get South African Post Office realtime tracking info of muti-carriers in one integration
   *   Provide South African Post Office shipment tracking experience like Amazon
   *   Push South African Post Office notifications of package update with webhook
   *   Verify South African Post Office delivery exception before it is too late
